...
llm = ChatOpenAI(model_name="gpt-3.5-turbo-16k-0613", temperature=0.3,openai_api_key=1638852301697749012,openai_api_base="https://aigc.sankuai.com/v1/openai/native")
...
"""
res=llm.predict('摘要下面内容:{}'.format(confusing_text))
print(res)